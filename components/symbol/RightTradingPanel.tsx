      ...
      <div className="p-2 flex flex-col gap-2">
        ...
        <div className="terminal-border p-1.5 flex flex-col gap-3">
          ...
          <div className="pt-2 border-t border-border-frame">
            ...
            <div className="grid grid-cols-1 gap-1.5 text-[10px] font-mono">
              <button
                className="px-2 py-1.5 bg-accent-violet/10 border border-accent-violet/30 text-accent-violet hover:bg-accent-violet/20 hover:border-accent-violet/50 transition-all rounded-sm hover:shadow-[0_0_8px_rgba(150,100,200,0.3)]"
                onClick={onMoveSL25}
                disabled={!position}
              >
                <span className="text-accent-violet/60 text-[10px] font-bold mr-1">5</span>
                ⟰ SL 25%
              </button>
              <button
                className="px-2 py-1.5 bg-accent-violet/10 border border-accent-violet/30 text-accent-violet hover:bg-accent-violet/20 hover:border-accent-violet/50 transition-all rounded-sm hover:shadow-[0_0_8px_rgba(150,100,200,0.3)]"
                ...
                disabled={!position}
              >
                <span className="text-accent-violet/60 text-[10px] font-bold mr-1">6</span>
                ⟰ SL 50%
              </button>
              <button
                className="px-2 py-1.5 bg-accent-violet/10 border border-accent-violet/30 text-accent-violet hover:bg-accent-violet/20 hover:border-accent-violet/50 transition-all rounded-sm hover:shadow-[0_0_8px_rgba(150,100,200,0.3)]"
                ...
                disabled={!position}
              >
                <span className="text-accent-violet/60 text-[10px] font-bold mr-1">7</span>
                ⟰ SL 75%
              </button>
              <button
                className="px-2 py-1.5 bg-accent-cyan/10 border border-accent-cyan/30 text-accent-cyan hover:bg-accent-cyan/20 hover:border-accent-cyan/50 transition-all rounded-sm hover:shadow-[0_0_8px_rgba(68,186,186,0.3)]"
                onClick={onMoveSLBreakeven}
                disabled={!position}
              >
                <span className="text-accent-cyan/60 text-[10px] font-bold mr-1">8</span>
                ⟰ BREAKEVEN
              </button>
            </div>
          </div>
          ...
          <div className="pt-2 border-t border-border-frame">
            ...
            <div className="flex flex-col gap-1.5">
              <button
                className="w-full px-2 py-1.5 bg-accent-orange/10 border border-accent-orange/30 text-accent-orange hover:bg-accent-orange/20 hover:border-accent-orange/50 transition-all rounded-sm hover:shadow-[0_0_8px_rgba(255,165,0,0.3)] text-[10px] font-mono"
