    ...
    return {
      ...
      scanner: {
        ...
        ascendingTriangleScanner: {
          enabled: storedSettings.scanner?.ascendingTriangleScanner?.enabled ?? DEFAULT_SETTINGS.scanner.ascendingTriangleScanner.enabled,
          timeframes: storedSettings.scanner?.ascendingTriangleScanner?.timeframes ?? DEFAULT_SETTINGS.scanner.ascendingTriangleScanner.timeframes,
          lookbackBars: storedSettings.scanner?.ascendingTriangleScanner?.lookbackBars ?? DEFAULT_SETTINGS.scanner.ascendingTriangleScanner.lookbackBars,
          pivotStrength: storedSettings.scanner?.ascendingTriangleScanner?.pivotStrength ?? DEFAULT_SETTINGS.scanner.ascendingTriangleScanner.pivotStrength,
          minHighPivots: storedSettings.scanner?.ascendingTriangleScanner?.minHighPivots ?? DEFAULT_SETTINGS.scanner.ascendingTriangleScanner.minHighPivots,
          minLowPivots: storedSettings.scanner?.ascendingTriangleScanner?.minLowPivots ?? DEFAULT_SETTINGS.scanner.ascendingTriangleScanner.minLowPivots,
          minSlopeR2: storedSettings.scanner?.ascendingTriangleScanner?.minSlopeR2 ?? DEFAULT_SETTINGS.scanner.ascendingTriangleScanner.minSlopeR2,
          minScore: storedSettings.scanner?.ascendingTriangleScanner?.minScore ?? DEFAULT_SETTINGS.scanner.ascendingTriangleScanner.minScore,
          weights: {
            flatness: storedSettings.scanner?.ascendingTriangleScanner?.weights?.flatness ?? DEFAULT_SETTINGS.scanner.ascendingTriangleScanner.weights.flatness,
            slope: storedSettings.scanner?.ascendingTriangleScanner?.weights?.slope ?? DEFAULT_SETTINGS.scanner.ascendingTriangleScanner.weights.slope,
            convergence: storedSettings.scanner?.ascendingTriangleScanner?.weights?.convergence ?? DEFAULT_SETTINGS.scanner.ascendingTriangleScanner.weights.convergence,
            volume: storedSettings.scanner?.ascendingTriangleScanner?.weights?.volume ?? DEFAULT_SETTINGS.scanner.ascendingTriangleScanner.weights.volume,
            ema: storedSettings.scanner?.ascendingTriangleScanner?.weights?.ema ?? DEFAULT_SETTINGS.scanner.ascendingTriangleScanner.weights.ema,
            proximity: storedSettings.scanner?.ascendingTriangleScanner?.weights?.proximity ?? DEFAULT_SETTINGS.scanner.ascendingTriangleScanner.weights.proximity,
          },
        },
        cupAndHandleScanner: {
          enabled: storedSettings.scanner?.cupAndHandleScanner?.enabled ?? DEFAULT_SETTINGS.scanner.cupAndHandleScanner.enabled,
          timeframes: storedSettings.scanner?.cupAndHandleScanner?.timeframes ?? DEFAULT_SETTINGS.scanner.cupAndHandleScanner.timeframes,
          lookbackBars: storedSettings.scanner?.cupAndHandleScanner?.lookbackBars ?? DEFAULT_SETTINGS.scanner.cupAndHandleScanner.lookbackBars,
          pivotStrength: storedSettings.scanner?.cupAndHandleScanner?.pivotStrength ?? DEFAULT_SETTINGS.scanner.cupAndHandleScanner.pivotStrength,
          minCupBars: storedSettings.scanner?.cupAndHandleScanner?.minCupBars ?? DEFAULT_SETTINGS.scanner.cupAndHandleScanner.minCupBars,
          maxCupBars: storedSettings.scanner?.cupAndHandleScanner?.maxCupBars ?? DEFAULT_SETTINGS.scanner.cupAndHandleScanner.maxCupBars,
          minHandleBars: storedSettings.scanner?.cupAndHandleScanner?.minHandleBars ?? DEFAULT_SETTINGS.scanner.cupAndHandleScanner.minHandleBars,
          maxHandleBars: storedSettings.scanner?.cupAndHandleScanner?.maxHandleBars ?? DEFAULT_SETTINGS.scanner.cupAndHandleScanner.maxHandleBars,
          maxRimAsymmetry: storedSettings.scanner?.cupAndHandleScanner?.maxRimAsymmetry ?? DEFAULT_SETTINGS.scanner.cupAndHandleScanner.maxRimAsymmetry,
          minCupDepth: storedSettings.scanner?.cupAndHandleScanner?.minCupDepth ?? DEFAULT_SETTINGS.scanner.cupAndHandleScanner.minCupDepth,
          maxCupDepth: storedSettings.scanner?.cupAndHandleScanner?.maxCupDepth ?? DEFAULT_SETTINGS.scanner.cupAndHandleScanner.maxCupDepth,
          maxHandlePullback: storedSettings.scanner?.cupAndHandleScanner?.maxHandlePullback ?? DEFAULT_SETTINGS.scanner.cupAndHandleScanner.maxHandlePullback,
          minScore: storedSettings.scanner?.cupAndHandleScanner?.minScore ?? DEFAULT_SETTINGS.scanner.cupAndHandleScanner.minScore,
          weights: {
            rimSymmetry: storedSettings.scanner?.cupAndHandleScanner?.weights?.rimSymmetry ?? DEFAULT_SETTINGS.scanner.cupAndHandleScanner.weights.rimSymmetry,
            cupRoundness: storedSettings.scanner?.cupAndHandleScanner?.weights?.cupRoundness ?? DEFAULT_SETTINGS.scanner.cupAndHandleScanner.weights.cupRoundness,
            cupDepth: storedSettings.scanner?.cupAndHandleScanner?.weights?.cupDepth ?? DEFAULT_SETTINGS.scanner.cupAndHandleScanner.weights.cupDepth,
            handlePullback: storedSettings.scanner?.cupAndHandleScanner?.weights?.handlePullback ?? DEFAULT_SETTINGS.scanner.cupAndHandleScanner.weights.handlePullback,
            handleVolume: storedSettings.scanner?.cupAndHandleScanner?.weights?.handleVolume ?? DEFAULT_SETTINGS.scanner.cupAndHandleScanner.weights.handleVolume,
            proximity: storedSettings.scanner?.cupAndHandleScanner?.weights?.proximity ?? DEFAULT_SETTINGS.scanner.cupAndHandleScanner.weights.proximity,
          },
        },
      },
      orders: {
